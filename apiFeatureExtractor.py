...
class APIfeatureExtractor():
    def __init__(self):
        ...
        self.mouthOpen = feature.Feature(scaleType = 2, curve = 0.5, decay=0.0001)
        self.eyeOpenLeft = feature.Feature(scaleType = 2, curve = 1, decay=0.0001)
        self.eyeOpenRight = feature.Feature(scaleType = 2, curve = 1, decay=0.0001)
        ...
        self.faceAngleX = feature.Feature( curve = 1, alpha=0.3, scaleType = 3, decay=0.000005)
        self.faceAngleY = feature.Feature( curve = 1, alpha=0.6, scaleType = 3, decay=0.000005)
        self.faceAngleZ = feature.Feature( curve = 1, alpha=0.6, scaleType = 3, decay=0.000005)
