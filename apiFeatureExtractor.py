...
class APIfeatureExtractor():
    def __init__(self):
        ...
        self.mouthX = feature.Feature(curve = 1, scaleType = 1,  spring = 0.5, friction = 0.33, mass = 1)
        self.mouthOpen = feature.Feature(scaleType = 2, curve = 0.66, decay=0.0001,  spring = 0.75, friction = 0.5, mass = 1)
